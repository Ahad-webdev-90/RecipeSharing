...
const AddRecipe = () => {
  ...
  return (
    <div className="h-[100vh] bg-[#7fd6b6] flex justify-center items-center">
      ...
      <div className="h-[80vh] w-[40%] bg-[#27a27c] rounded-lg shadow-lg flex flex-col justify-center items-center px-8 overflow-auto">
        ...
        {loading ? (
          <button
            type="button"
            className="bg-[#082620] my-3 text-[#7fd6b6] px-20 py-2 rounded-lg outline-none transition-all duration-300 focus:ring-4 focus:ring-[#125343]"
          >
            <Loading />
          </button>
        ) : (
